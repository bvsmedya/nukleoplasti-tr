    ...
    <footer className="bg-gray-900 text-white py-12 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            <h3 className="text-lg font-bold mb-4 border-l-4 border-blue-600 pl-3">Hızlı Erişim</h3>
            <ul className="space-y-2 text-gray-400">
              ...
              <li>
                <a href="https://www.emaryolla.com" target="_blank" rel="noopener noreferrer" className="text-orange-500 font-bold hover:text-orange-400 transition flex items-center">
              ...
              <li className="pt-2 border-t border-gray-800">
                <Link href="/kvkk" className="text-xs hover:text-white transition opacity-60 uppercase tracking-tighter">
          ...
          <div>
            <h3 className="text-lg font-bold mb-4 border-l-4 border-blue-600 pl-3">Bize Ulaşın</h3>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-500 text-xs">
          ...
          <p className="mt-2 leading-relaxed">
            ÖNEMLİ: Bu sitedeki bilgiler bilgilendirme amaçlıdır. <br className="hidden md:block" />
            Tanı ve tedavi için mutlaka doktorunuza başvurun.
          </p>
        </div>
      </div>
    </footer>
